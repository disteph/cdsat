...
(* OASIS_START *)
(* DO NOT EDIT (digest: 34c166b504e3c1bd8d2694c2e5f2f8fb) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "psyche_kernel_lib";
                           FindlibPackage ("ppx_deriving.std", None);
                           FindlibPackage ("ppx_hash", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\198\192(\195m\140\016\224Za-\238\016\248\"\183";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
