...
(* OASIS_START *)
(* DO NOT EDIT (digest: 41f09c2e7572bfc318a79cb89e31eba2) *)
(*
...
let setup_t =
  {
     ...
     doc =
       [
          ...
          ("Kernel",
            OCamlbuildDocPlugin.doc_build
              {OCamlbuildDocPlugin.extra_args = []; run_path = "src/kernel"});
          ("Run_tools",
            OCamlbuildDocPlugin.doc_build
              {
                 OCamlbuildDocPlugin.extra_args = [];
                 run_path = "src/run_tools"
              });
          ("Lib",
            OCamlbuildDocPlugin.doc_build
              {OCamlbuildDocPlugin.extra_args = []; run_path = "src/lib"});
          ("Empty",
            OCamlbuildDocPlugin.doc_build
              {
                 OCamlbuildDocPlugin.extra_args = [];
                 run_path = "src/theories/Empty"
              });
          ("LRA",
            OCamlbuildDocPlugin.doc_build
              {
                 OCamlbuildDocPlugin.extra_args = [];
                 run_path = "src/theories/LRA"
              });
          ("Naive",
            OCamlbuildDocPlugin.doc_build
              {
                 OCamlbuildDocPlugin.extra_args = [];
                 run_path = "src/gplugins/Naive"
              });
          ("DPLL_Pat",
            OCamlbuildDocPlugin.doc_build
              {
                 OCamlbuildDocPlugin.extra_args = [];
                 run_path = "src/gplugins/DPLL_Pat"
              });
          ("DPLL_WL",
            OCamlbuildDocPlugin.doc_build
              {
                 OCamlbuildDocPlugin.extra_args = [];
                 run_path = "src/gplugins/DPLL_WL"
              });
          ("Common",
            OCamlbuildDocPlugin.doc_build
              {
                 OCamlbuildDocPlugin.extra_args = [];
                 run_path = "src/gplugins/Common"
              })
       ];
