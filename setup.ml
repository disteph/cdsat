...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8196d0531dd64a3fce95f77ae7410669) *)
(*
...
let setup_t =
  {
     ...
     build =
       OCamlbuildPlugin.build
         ["-use-ocamlfind"; "-plugin-tags"; "'package(mld)'"];
     test = [];
     doc = [];
     ...
     package =
       {
          ...
          authors =
            [
               ...
               "CNRS\nAlexis Bernadet";
               "Ecole Polytechnique\nMahfuza Farooque";
               "CNRS\nGuillaume H\195\169tier";
               "Ecole Polytechnique\nZelda Mariet";
               "Ecole Polytechnique\nCl\195\169ment Pit-Claudel";
               "Ecole Polytechnique\nDamien Rouhling";
               "ENS Lyon\nAndr\195\169 Schrottenloher";
               "Ecole Polytechnique\nMatthieu Vegreville";
               "Ecole Polytechnique"
            ];
          homepage = None;
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Target is Psyche's kernel's lib";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EFlag "kernel_lib", true)
                        ];
                      bs_install =
                        [
                           (OASISExpr.EBool true, false);
                   ...
                   {
                      lib_modules = ["General"; "Open"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "psyche_kernel_lib";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Target is Psyche's kernel";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Kernel"; "Dump"; "Flags"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "psyche_kernel";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Target is Psyche's portfolio of plugins";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "portfolio", true)
                        ];
                      bs_install =
                        [
                           (OASISExpr.EBool true, false);
                   ...
                   {
                      lib_modules = ["Plugins"; "PluginsTh"; "PFlags"];
                      lib_pack = false;
                      lib_internal_modules = ["Tools"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "psyche_portfolio";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Target is Psyche's executable";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Executable
                 ({
     ...
     oasis_digest = Some "\2439\145\1819\027r'\188!\011\204\215\243\140\160";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
