...
(* OASIS_START *)
(* DO NOT EDIT (digest: 27e713aa9cd00cc4b06cfc0060408a0e) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors =
            [
               "Alexis Bernadet <bernadet@lix.polytechnique.fr>";
               "Ecole Polytechnique\nMahfuza Farooque <mahfuza@lix.polytechnique.fr>";
               "CNRS\nStephane Graham-Lengrand <graham-lengrand@lix.polytechnique.fr>";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\255\1990\170\224t%\149\239\206u+\197\144\017X";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
