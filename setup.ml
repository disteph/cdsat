...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5c495ec4b47f628920e94c5b5b914a73) *)
(*
     ...
     package =
       {
          ...
          authors =
            [
               "Dr Stephane Lengrand <lengrand@lix.polytechnique.fr>";
               "Miss Mahfuza Farooque <mahfuza@lix.polytechnique.fr>";
               "Mlle Assia Mahboubi <assia.mahboubi@inria.fr>\nAlexis Bernadet <bernadet@lix.polytechnique.fr>"
            ];
          homepage = None;
