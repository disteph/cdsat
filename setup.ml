...
(* OASIS_START *)
(* DO NOT EDIT (digest: e060070874564eaea23af88dc5cb6f63) *)
(*
...
let setup_t =
  {
     ...
     build =
       OCamlbuildPlugin.build
         ["-use-ocamlfind"; "-plugin-tags"; "'package(str)'"];
     test = [];
     doc = [];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\159#\227\134t6\020\017\151T\219&\031\176\139\225";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
